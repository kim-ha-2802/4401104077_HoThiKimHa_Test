...
WebUI.navigateToUrl('https://katalon-demo-cura.herokuapp.com/?fbclid=IwAR0hOMTaed6_a61Ca1umkqUR3I5TVz56wZY6iDN54DmJw9PLVj-deg8WkuU')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/a_Make Appointment'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Username_username'), '4401104077@student.hcmue.edu.vn')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Password_password'), 'l7y7hIkMBIXzHpFhwjIGiA==')
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_Password_col-sm-8'))
